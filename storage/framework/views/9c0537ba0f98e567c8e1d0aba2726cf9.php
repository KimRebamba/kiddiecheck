        ...
        <table class="table table-hover">
          ...
          <tbody>
            <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php $standardScore = $test->standardScore; ?>
              <tr>
                <td>
                  <div class="d-flex align-items-center gap-2">
                    <div class="table-avatar"><?php echo e(strtoupper(substr($test->student->first_name, 0, 1))); ?></div>
                    <span class="fw-semibold"><?php echo e($test->student->first_name); ?> <?php echo e($test->student->last_name); ?></span>
                  </div>
                </td>
                <td><span class="period-text"><?php echo e($test->assessmentPeriod->description); ?></span></td>
                <td><span class="date-text"><?php echo e($test->test_date->format('M d, Y')); ?></span></td>
                <td><span class="badge bg-success"><?php echo e(ucfirst($test->status)); ?></span></td>
                <td>
                  <?php if($standardScore): ?>
                    <span class="score-badge"><?php echo e($standardScore->standard_score); ?></span>
                  <?php else: ?>
                ...
                <td>
                  <?php if($standardScore): ?>
                    <span class="interp-badge interp-<?php echo e(Str::slug($standardScore->interpretation)); ?>">
                ...
                <td>
                  <a href="<?php echo e(route('teacher.reports.detail', [$test->student_id, $test->period_id, $test->test_id])); ?>"
...
<?php echo $__env->make('teacher.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sedriel Navasca\Desktop\SAAD\Kiddiecheck\kiddiecheck\resources\views/teacher/reports.blade.php ENDPATH**/ ?>