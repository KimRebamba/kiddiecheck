...
<div class="card">
    ...
    {{-- ── CHANGE: swap the Blade variables below to match your controller ── --}}

    <!-- CHANGE: "$totalAnswered of $totalQuestions answered" — replace with Blade: {{ $totalAnswered }} of {{ $totalQuestions }} answered -->
    <div class="progress" id="progress">{{ $totalAnswered }} of {{ $totalQuestions }} answered</div>
    ...
    <!-- CHANGE: domain name — replace with Blade: {{ $currentDomain->domain_name }} -->
    <div class="domain-title">{{ $currentDomain->domain_name }}</div>

    <!-- CHANGE: question instruction text — replace with Blade: {{ $question->display_text }} -->
    ...
    <input type="hidden" name="response" id="responseInput" value="">
        ...
        <div class="nav-footer">
            ...
            <!--
                ...
                href="{{ route('family.tests.question', ['test' => $testId, 'domain' => $prevDomain, 'index' => $prevIndex]) }}"
        ...
        @endif
            ...
            <div class="nav-center">
                ...
                <!--
                    ...
                    href="{{ route('family.tests.question', ['test' => $testId, 'domain' => $nextDomain, 'index' => $nextIndex]) }}"
...
//        const existingResponse = '{{ $existingResponse ?? "" }}';
// ============================================================
