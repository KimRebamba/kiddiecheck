...
?>
  ...
  <header class="family-header">
    <div class="header-container">
      ...
      <a class="brand" href="<?php echo e(route('family.index')); ?>">
      ...
      <div class="nav-links">
        <a class="nav-link <?php echo e(request()->routeIs('family.index') ? 'active' : ''); ?>" href="<?php echo e(route('family.index')); ?>">Home</a>
        <a class="nav-link <?php echo e(request()->routeIs('family.index') ? 'active' : ''); ?>" href="<?php echo e(route('family.index')); ?>#family-children">Children</a>
        <a class="nav-link <?php echo e(request()->routeIs('family.tests.*') ? 'active' : ''); ?>"
           href="<?php echo e($navStudent && $navStudent->student_id ? route('family.tests.start.show', $navStudent->student_id) : route('family.index')); ?>">Current Test</a>
        <a class="nav-link <?php echo e(request()->routeIs('family.help') ? 'active' : ''); ?>" href="<?php echo e(route('family.help')); ?>">Help</a>

      
      <div class="profile-section">
        <div class="profile-menu">
          <a href="<?php echo e($navStudent && $navStudent->student_id ? route('family.student.profile', $navStudent->student_id) : route('family.index')); ?>" class="profile-button" tabindex="0" id="profileBtn">
          ...
          <div class="profile-dropdown" id="profileDropdown">
            ...
            <a href="<?php echo e(route('family.profile')); ?>" class="pd-item">
            ...
            <hr class="pd-divider">
            <a href="<?php echo e(route('logout')); ?>" class="pd-item danger">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
...
</html><?php /**PATH C:\Users\Sedriel Navasca\Desktop\SAAD\Kiddiecheck\kiddiecheck\resources\views/family/layout.blade.php ENDPATH**/ ?>