          ...
          <div class="card-body">
            ...
            <div class="section-card-top">
              <div class="section-avatar">
                <?php echo e(strtoupper(substr($section->section_name, 0, 1))); ?>

              </div>
              <div class="section-meta">
                <h5 class="card-title mb-0"><?php echo e($section->section_name); ?></h5>
                    ...
                    <div class="families-list">
                      <?php
                        ...
                        $sectionStudents = DB::table('student_teacher as st')
                          ...
                          ->toArray();
                      ?>
                      <?php $__currentLoopData = $sectionStudents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $family): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="family-badge"><?php echo e($family); ?></span>
