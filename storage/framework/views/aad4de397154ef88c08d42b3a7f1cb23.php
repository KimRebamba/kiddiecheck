    ...
    <div class="header-container">
      ...
      <div class="nav-links">
        ...
        <a class="nav-link <?php echo e(request()->routeIs('family.tests.*') ? 'active' : ''); ?>"
           href="<?php echo e($navStudent ? route('family.tests.start.show', $navStudent->student_id) : route('family.index')); ?>">Current Test</a>
        <a class="nav-link <?php echo e(request()->routeIs('family.index') ? 'active' : ''); ?>" href="<?php echo e(route('family.index')); ?>#family-help">Help</a>
      </div>

      <div class="profile-section">
        <div class="profile-menu">
          <a href="<?php echo e($navStudent ? route('family.student.profile', $navStudent->student_id) : route('family.index')); ?>" class="profile-button" tabindex="0">
          ...
          <div class="dropdown-menu">
            <a href="<?php echo e($navStudent ? route('family.student.profile', $navStudent->student_id) : route('family.index')); ?>" 
...
</html><?php /**PATH C:\Users\Kim\Desktop\laravel\kiddiecheck\resources\views\family\layout.blade.php ENDPATH**/ ?>