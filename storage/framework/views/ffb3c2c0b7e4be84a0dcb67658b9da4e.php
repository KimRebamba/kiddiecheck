                        ...
                        <?php if($student->eligible): ?>
                          ...
                          <?php if($availablePeriod): ?>
                            <?php if($inProgressTest): ?>
                              <a href="<?php echo e(route('teacher.tests.form', $inProgressTest->test_id)); ?>" class="btn btn-outline-primary">Continue Test</a>
                            <?php else: ?>
...
<?php echo $__env->make('teacher.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Kim\Desktop\laravel\kiddiecheck\resources\views\teacher\sections_show.blade.php ENDPATH**/ ?>