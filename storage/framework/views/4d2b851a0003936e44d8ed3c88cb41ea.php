  ...
  <div class="row g-3">
    <?php $__currentLoopData = $families; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $family): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="col-md-6 col-lg-4">
        <div class="family-card card" style="cursor:pointer;" data-bs-toggle="modal" data-bs-target="#familyModal<?php echo e($family->user_id); ?>">
          <div class="card-body">

            <div class="family-card-top">
              <div>
                <h5 class="card-title mb-0"><?php echo e($family->family_name); ?></h5>
                <span class="student-pill">
                  <i class="fas fa-user-friends me-1"></i>
                  <?php echo e($family->students->count()); ?> <?php echo e(Str::plural('student', $family->students->count())); ?>
            ...
            <div class="family-info-grid">
              <div class="info-item">
                ...
                <span class="info-value"><?php echo e($family->home_address); ?></span>
              </div>
              <div class="info-item">
                <span class="info-label"><i class="fas fa-phone-alt me-1"></i>Emergency</span>
                <span class="info-value"><?php echo e($family->emergency_contact); ?> · <?php echo e($family->emergency_phone); ?></span>
              </div>
            </div>
            ...
            <button class="btn btn-sm btn-outline-primary mt-3"
              ...
              data-bs-target="#familyModal<?php echo e($family->user_id); ?>">
          ...
          <div class="modal-content">
            ...
            <div class="modal-header">
              <div>
                ...
                <span class="modal-subtitle"><?php echo e($family->students->count()); ?> <?php echo e(Str::plural('student', $family->students->count())); ?> assigned</span>
              </div>
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                    <div class="info-block">
                      ...
                      <div class="info-block-value"><?php echo e($family->family_name); ?></div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="info-block">
                      <div class="info-block-label">Home Address</div>
                      <div class="info-block-value"><?php echo e($family->home_address); ?></div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="info-block">
                      <div class="info-block-label">Emergency Contact</div>
                      <div class="info-block-value"><?php echo e($family->emergency_contact); ?></div>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="info-block">
                      <div class="info-block-label">Emergency Phone</div>
                      <div class="info-block-value"><?php echo e($family->emergency_phone); ?></div>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <table class="table table-sm">
                      ...
                      <tbody>
                        <?php $__currentLoopData = $family->students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <tr>
                            <td>
                              <span class="fw-semibold"><?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></span>
                            </td>
                            <td><?php echo e($age); ?> yrs</td>
                            <td><span class="badge bg-primary"><?php echo e(optional($student->section)->name ?? 'N/A'); ?></span></td>
                            <td>
                              <a href="<?php echo e(route('teacher.student', $student->student_id)); ?>" class="btn btn-xs btn-outline-primary">
            ...
            <div class="modal-footer">
              ...
              <a href="<?php echo e(route('teacher.reports')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('teacher.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sedriel Navasca\Desktop\SAAD\Kiddiecheck\kiddiecheck\resources\views/teacher/family.blade.php ENDPATH**/ ?>