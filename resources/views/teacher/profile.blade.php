...
<div class="d-flex align-items-center mb-4">
  ...
  <div class="ms-auto">
    <a href="{{ route('teacher.index') }}" class="btn btn-ghost-back">
...
<div class="profile-hero mb-4">
  ...
  <div class="profile-hero-info">
    <div class="profile-hero-name">{{ $teacher->first_name ?? $user->username }} {{ $teacher->last_name ?? '' }}</div>
...
<div class="row g-3">
  ...
  <div class="col-6 col-md-3">
    <div class="stat-card stat-violet">
      ...
      <div class="stat-num">{{ $assignedStudents }}</div>
  ...
  <div class="col-6 col-md-3">
    <div class="stat-card stat-mint">
      ...
      <div class="stat-num">{{ $completedTests }}</div>
  ...
  <div class="col-6 col-md-3">
    <div class="stat-card stat-lemon">
      ...
      <div class="stat-num">{{ $inProgressTests }}</div>
      ...
      <div class="card-body">
        ...
        @if($teacher)
          <div class="info-row">
            ...
            <span class="info-value">{{ $teacher->first_name ?? 'N/A' }}</span>
          </div>
          <div class="info-row">
            <span class="info-label">Last Name</span>
            <span class="info-value">{{ $teacher->last_name ?? 'N/A' }}</span>
          </div>
        @endif
      </div>
    </div>
    ...
    <div class="card h-100">
      ...
      <div class="card-body">
        <div class="info-row">
          ...
          <span class="info-value">{{ $teacher->home_address ?? 'N/A' }}</span>
        </div>
        <div class="info-row">
          <span class="info-label">Phone Number</span>
          <span class="info-value">{{ $teacher->phone_number ?? 'N/A' }}</span>
        </div>
        <div class="info-row">
          <span class="info-label">Hire Date</span>
          <span class="info-value">{{ $hireDate ? $hireDate->format('M d, Y') : 'N/A' }}</span>
        </div>
      </div>
    </div>
  </div>
