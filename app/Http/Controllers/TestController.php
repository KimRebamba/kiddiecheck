...

{
...

    {
        ...
        $domains = DB::table('domains')->orderBy('domain_id')->get();

        

        foreach ($domains as $domain) {

            $domainScore = DB::table('test_responses')

                ->join('questions', 'test_responses.question_id', '=', 'questions.question_id')

                ->where('test_responses.test_id', $testId)

                ->where('questions.domain_id', $domain->domain_id)

                ->where('test_responses.response', 'yes')
...

    {
        ...
        return match(true) {
            ...
            $standardScore >= 130 => 'Very Superior',

            $standardScore >= 120 => 'Superior',

            $standardScore >= 110 => 'High Average',

            $standardScore >= 90  => 'Average',

            $standardScore >= 80  => 'Low Average',

            $standardScore >= 70  => 'Borderline',
