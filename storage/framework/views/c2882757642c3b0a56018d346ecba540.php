                    ...
                    <td>
                      ...
                      <?php if($student->eligible && $period->status !== 'completed' && $period->status !== 'overdue' && $period->end_date >= now()->startOfDay()): ?>
                        ...
                        <?php if($inProgressTest): ?>
                          ...
                          <a href="<?php echo e(route('teacher.tests.question', [$inProgressTest->test_id, 1, 0])); ?>" class="btn btn-sm btn-outline-primary">Continue Test</a>
...
<?php echo $__env->make('teacher.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Sedriel Navasca\Desktop\SAAD\Kiddiecheck\kiddiecheck\resources\views/teacher/student.blade.php ENDPATH**/ ?>