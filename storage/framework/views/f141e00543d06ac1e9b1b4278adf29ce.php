...
<body>
    <div class="complete-container">
        ...
        <p style="text-align: center; font-size: 1.2rem; color: #666;">
            Student: <strong><?php echo e($student->first_name); ?> <?php echo e($student->last_name); ?></strong>
        </p>
        ...
        <div class="score-grid">
            <?php $__currentLoopData = $domainScores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $score): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="score-card">
                    ...
                    <small style="font-size: 0.9rem; opacity: 0.9;"><?php echo e($score['score']); ?> correct (yes)</small>
                    <p><?php echo e($score['percentage']); ?>%</p>
                </div>
...
</html><?php /**PATH C:\Users\Kim\Desktop\laravel\kiddiecheck\resources\views\test\complete.blade.php ENDPATH**/ ?>