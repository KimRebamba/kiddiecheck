  ...
  <div class="row g-3">
    <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="col-md-6 col-lg-4">
        <div class="card" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#sectionModal<?php echo e($section->id); ?>">
          <div class="card-body">
            ...
            <?php endif; ?>
            <button class="btn btn-sm btn-outline-primary" onclick="event.stopPropagation();" data-bs-toggle="modal" data-bs-target="#sectionModal<?php echo e($section->id); ?>">
              View Students
            </button>
          </div>
        </div>
      ...
      <div class="modal fade" id="sectionModal<?php echo e($section->id); ?>" tabindex="-1">
...
<?php echo $__env->make('teacher.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Kim\Desktop\laravel\kiddiecheck\resources\views\teacher\sections.blade.php ENDPATH**/ ?>